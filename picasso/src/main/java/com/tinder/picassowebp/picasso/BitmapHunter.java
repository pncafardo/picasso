...
import static com.tinder.picassowebp.picasso.AssetBitmapHunter.ANDROID_ASSET;
...
abstract class BitmapHunter implements Runnable {
   ...
   * {@link com.tinder.picassowebp.picasso.Request}, only instantiating them if needed.
   */
